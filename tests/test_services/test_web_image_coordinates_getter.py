...
@mock.patch("pic_back.services.web_image_coordinates_getter.requests.get")
@mock.patch("pic_back.services.web_image_coordinates_getter.io.BytesIO")
def test_web_image_coords_getter_from_image_with_exif_coords(mock_bytes_io_cls, mock_requests_get):
...
@mock.patch("pic_back.services.web_image_coordinates_getter.requests.get")
@mock.patch("pic_back.services.web_image_coordinates_getter.io.BytesIO")
def test_web_image_coords_getter_from_image_with_exif_but_no_coords(mock_bytes_io_cls, mock_requests_get):
    img_url = "www.dummy.com/images/img.jpg"
...
@mock.patch("pic_back.services.web_image_coordinates_getter.requests.get")
@mock.patch("pic_back.services.web_image_coordinates_getter.io.BytesIO")
def test_web_image_coords_getter_from_image_without_exif(mock_bytes_io_cls, mock_requests_get):
    img_url = "www.dummy.com/images/img.jpg"
