...
from pic_back.db.utils import DbCategoriesOperations, DbImagesOperations
...
def test_add_single_category_to_image_with_authenticated_user_should_return_200(access_token):
    img_id = "0001-1213"
    category_name = "cars"
    DbImagesOperations.create(Image(id=img_id, name="image.jpg"))
    DbCategoriesOperations.create(Category(name="cars"))
